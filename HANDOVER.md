...
Which edge source? Three genuinely different projects, wanting different
...
Does a persistently skilled wallet cohort actually exist? The whole
...
Is skill distinguishable from size/luck? A wallet with 1000 trades at
...
with small n.
Is the signal actionable after latency? A smart wallet's trade is public
...
smart-wallet fill.
What is the Edge-Factory / Polymarket market overlap? Measure it; do not
